...
import { getDatabase, ref, child, set, get, push, update, off, onValue, onChildAdded, onDisconnect, runTransaction } from "https://www.gstatic.com/firebasejs/12.17.1/firebase-database.js";
...
export { database, ref, child, set, get, push, update, off, onValue, onChildAdded, onDisconnect, runTransaction, auth, signInAnonymously }